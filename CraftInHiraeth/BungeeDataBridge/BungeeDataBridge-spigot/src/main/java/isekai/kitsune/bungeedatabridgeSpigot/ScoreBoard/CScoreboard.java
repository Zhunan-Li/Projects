...
public class CScoreboard {
    ...
    private final String name, criterion; //GETTER

    private final Scoreboard bukkitScoreboard;
    private final Objective obj;
    String title; //GETTER
    private Row[] rows = new Row[0]; //GETTER
    ...
    public static class Row {
        ...
        private final CScoreboard scoreboard; //GETTER
        private Team team;
        private final int rowInScoreboard; //GETTER
