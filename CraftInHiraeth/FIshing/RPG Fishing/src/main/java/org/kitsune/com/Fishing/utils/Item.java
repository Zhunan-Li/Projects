...
public class Item {
    ...
    private HerbItem itemStack;

    public Item(String name, int difficult_min, int difficult_max, int pullTimes_min, int pullTimes_max, int xp_min, int xp_max, int chance_min, int chance_max, int level_min, int level_max, List<String> region) {
    ...
    public HerbItem getItemStack() {
        return this.itemStack;
    }

    public void setItemStack(HerbItem itemStack) {
